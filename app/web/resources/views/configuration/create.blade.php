...
<div class="min-h-screen bg-gray-50">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
            <form action="{{ route('configurations.store') }}" method="POST" class="space-y-6 p-6">
                @csrf
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="key" id="key" value="{{ old('key') }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-theme-accent focus:border-theme-accent sm:text-sm" placeholder="e.g., app_name, max_upload_size">
                    ...
                    <div>
                        ...
                        <textarea name="value" id="value" rows="6" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-theme-accent focus:border-theme-accent sm:text-sm font-mono" placeholder='e.g., "hello", true, 1, {"key": "value"}, ["item1", "item2"]'>{{ old('value') }}</textarea>
