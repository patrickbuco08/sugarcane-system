...
<div class="min-h-screen bg-gray-50">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
            <form action="{{ route('harvest-batches.update', $harvestBatch) }}" method="POST" class="space-y-6 p-6">
                @csrf
                @method('PUT')
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="label" id="label" value="{{ old('label', $harvestBatch->label) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-theme-accent focus:border-theme-accent sm:text-sm">
                        @error('label')
...
<!-- Weekly Price ID -->
                    <div>
                        ...
                        <select name="weekly_price_id" id="weekly_price_id" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-theme-accent focus:border-theme-accent sm:text-sm">
                            @foreach(\Bocum\Models\WeeklyPrice::orderBy('week_of', 'desc')->get() as $price)
                                <option value="{{ $price->id }}" {{ old('weekly_price_id', $harvestBatch->weekly_price_id) == $price->id ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            <input type="number" name="tons_harvested" id="tons_harvested" step="0.01" min="0" value="{{ old('tons_harvested', $harvestBatch->tons_harvested) }}" class="block w-full pr-12 border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:ring-theme-accent focus:border-theme-accent sm:text-sm">
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            <input type="number" name="recovery_coeff" id="recovery_coeff" step="0.001" min="0" max="1" value="{{ old('recovery_coeff', $harvestBatch->recovery_coeff) }}" class="block w-full pr-12 border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:ring-theme-accent focus:border-theme-accent sm:text-sm">
                            <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            <input type="number" name="farmers_share" id="farmers_share" step="0.01" min="0" max="1" value="{{ old('farmers_share', $harvestBatch->farmers_share) }}" class="block w-full pr-12 border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:ring-theme-accent focus:border-theme-accent sm:text-sm">
                            <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                <span class="text-gray-500 sm:text-sm">0-1</span>
                            </div>
                        </div>
