...
@section('title', 'Create Weekly Price')
...
<div class="min-h-screen bg-gray-50">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
            <form action="{{ route('weekly-prices.store') }}" method="POST" class="space-y-6 p-6">
                @csrf
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="date" name="week_of" id="week_of" value="{{ old('week_of') }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-theme-accent focus:border-theme-accent sm:text-sm">
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <input type="number" name="b_domestic" id="b_domestic" step="0.01" min="0" value="{{ old('b_domestic') }}" class="block w-full pl-7 pr-16 border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:ring-theme-accent focus:border-theme-accent sm:text-sm">
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <input type="number" name="a_us_quota" id="a_us_quota" step="0.01" min="0" value="{{ old('a_us_quota') }}" class="block w-full pl-7 pr-16 border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:ring-theme-accent focus:border-theme-accent sm:text-sm">
                            <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                <span class="text-gray-500 sm:text-sm">/LKG</span>
                            </div>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <input type="number" name="molasses_mt" id="molasses_mt" step="0.01" min="0" value="{{ old('molasses_mt') }}" class="block w-full pl-7 pr-16 border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:ring-theme-accent focus:border-theme-accent sm:text-sm">
                            <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                    ...
                    <div>
                        ...
                        <input type="text" name="source" id="source" value="{{ old('source', 'SRA Weekly Millsite Prices') }}" maxlength="120" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-theme-accent focus:border-theme-accent sm:text-sm">
